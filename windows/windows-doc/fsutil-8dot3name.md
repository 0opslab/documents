...
|/l [<log file>]|Specifies a log file where information is written.<br /><br />If the **/l** parameter is not specified, all information is written to the default log file:<br /><br />**%temp%\8dot3_removal_log@(***GMT YYYY-MM-DD HH-MM-SS***).log**|
