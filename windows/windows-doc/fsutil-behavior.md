...
|encryppagingfile {1&#124;0}|Encrypts (**1**) or does not encrypt (**0**) the memory paging file in the Windows operating system.<br /><br />You must restart your computer for this parameter to take effect.|
